...
public final class InfoBottomSheetBinding implements ViewBinding {
  ...
  @NonNull
  public final LineChart averageConfidenceChart;
  ...
  @NonNull
  public final LineChart instantaneousConfidenceChart;
  ...
  @NonNull
  public final TextView textViewAverageConfidence;
  ...
  @NonNull
  public final TextView textViewInstantaneousConfidence;
  ...
  private InfoBottomSheetBinding(@NonNull NestedScrollView rootView,
      @NonNull LineChart averageConfidenceChart, @NonNull LineChart batteryConsumptionChart,
      @NonNull LineChart batteryLevelChart, @NonNull NestedScrollView bottomSheetLayout,
      @NonNull LineChart cpuUsageChart, @NonNull ImageView graphsIcon,
      @NonNull LinearLayout graphsSection, @NonNull TextView inferenceTimeLabel,
      @NonNull TextView inferenceTimeVal, @NonNull LineChart instantaneousConfidenceChart,
      ...
      @NonNull LinearLayout statsSection, @NonNull TextView textViewAverageConfidence,
      @NonNull TextView textViewBatteryConsumption, @NonNull TextView textViewBatteryLevel,
      @NonNull TextView textViewCpuUsage, @NonNull TextView textViewInstantaneousConfidence,
    ...
    this.averageConfidenceChart = averageConfidenceChart;
    ...
    this.instantaneousConfidenceChart = instantaneousConfidenceChart;
    ...
    this.textViewAverageConfidence = textViewAverageConfidence;
    ...
    this.textViewInstantaneousConfidence = textViewInstantaneousConfidence;
  ...
  public static InfoBottomSheetBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.averageConfidenceChart;
      LineChart averageConfidenceChart = ViewBindings.findChildViewById(rootView, id);
      if (averageConfidenceChart == null) {
        break missingId;
      }
      ...
      id = R.id.instantaneousConfidenceChart;
      LineChart instantaneousConfidenceChart = ViewBindings.findChildViewById(rootView, id);
      if (instantaneousConfidenceChart == null) {
        break missingId;
      }
      ...
      id = R.id.textViewAverageConfidence;
      TextView textViewAverageConfidence = ViewBindings.findChildViewById(rootView, id);
      if (textViewAverageConfidence == null) {
        break missingId;
      }
      ...
      id = R.id.textViewInstantaneousConfidence;
      TextView textViewInstantaneousConfidence = ViewBindings.findChildViewById(rootView, id);
      if (textViewInstantaneousConfidence == null) {
        break missingId;
      }
      ...
      return new InfoBottomSheetBinding((NestedScrollView) rootView, averageConfidenceChart,
          batteryConsumptionChart, batteryLevelChart, bottomSheetLayout, cpuUsageChart, graphsIcon,
          graphsSection, inferenceTimeLabel, inferenceTimeVal, instantaneousConfidenceChart,
          maxResultsMinus, maxResultsPlus, maxResultsValue, spinnerDelegate, spinnerModel,
          statsIcon, statsSection, textViewAverageConfidence, textViewBatteryConsumption,
          textViewBatteryLevel, textViewCpuUsage, textViewInstantaneousConfidence,
          textViewSelectedModel, threadsMinus, threadsPlus, threadsValue, thresholdMinus,
